...
{{- if contains $name .Values.helmReleaseName -}}
{{- .Values.helmReleaseName | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Values.helmReleaseName $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- printf "%s-%s-headless" .Values.helmReleaseName $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
